...
def savings(gross_pay, tax_rate, expenses):
    ...
    take_home_pay = int(gross_pay * (1 - tax_rate))
    remaining_pay = take_home_pay - expenses
...
def body_mass_index(weight, height):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    lbs_to_kg = weight * 0.45359237

    height_feet = height[0]
    height_inches = height[1]
    inches_to_meters = (height_feet * 12 + height_inches) * 0.0254

    bmi = lbs_to_kg / (inches_to_meters ** 2)
